 ...
 *   - number of BSS using IEEE 802.11ax or IEEE 802.11bf.
 *   - etc.
 *
 * For example, to observe the effect number of stations increased:
 *   ./ns3 run "wifi-bf-network.cc --nStations=2"
 *   ./ns3 run "wifi-bf-network.cc --nBss=5 --nAxBss=2 --nBfBss=3"
 *
...
main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        //O trigger frame é broad ou uni?
        // Ele trata dos preambulos?
        // DEBUGGG
        //FOR DEBUG PURPOSE
